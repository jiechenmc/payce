...
const TableRow = ({ record }: { record?: DebtRecord }) => {
    return <div className="grid grid-cols-6 gap-4 p-4 items-center">
        ...
        <TableCell forId="totalPayment" text="Total Payment" type="number" value={record?.totalPayment}></TableCell>
        <TableCell forId="downPayment" text="Down Payment" type="number" value={record?.downPayment}></TableCell>
        <TableCell forId="monthlyPayment" text="Month Payment" type="number" value={record?.monthlyPayment}></TableCell>
